...
async def sticklet(event):
    ...
    await event.client.send_file(event.chat_id, image_stream, caption="Created Using Megastar userbot", reply_to=event.message.reply_to_msg_id)
    # cleanup
    try:
        os.remove(FONT_FILE)
    except:
