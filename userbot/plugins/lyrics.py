...
async def _(event):
    megaevent = await edit_or_reply(event, "wi8..! I am searching your lyrics....")
    ...
    if event.pattern_match.group(1):
        ...
        await megaevent.edit("What I am Supposed to find ")
        return
    song = ""
...
async def lyrics(lyric):
    ...
    try:
        ...
        songs = None
    if songs is None:
        await megaevent.edit(f"Song **{artist} - {song}** not found!")
        return
    if len(songs.lyrics) > 4096:
        await megaevent.edit("Lyrics is too big, view the file to see it.")
