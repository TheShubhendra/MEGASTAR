...
NO_ADMIN = "`I am not an admin noob😔!`"
NO_PERM = (
    "`I don't have sufficient permissions! This is so sed. owner can you please give me the permission for good`"
)
...
async def ban(event):
    ...
    if not admin and not creator:
        await event.reply("Alas! I Am Not an Admin 🥺.")
        return
    ...
    try:
        ...
        await event.reply("No Permission🥺 sed lyf.")
        return
...
async def nothanos(event):
    ...
    creator = chat.creator
    if not admin and not creator:
        await event.reply("Me not admin..not fare😔")
        return
...
async def demote(event):
    ...
    # Assume we don't have permission to demote
        ...
        await event.reply("Me noob. have no permission 🙄")
        return
...
async def pin(event):
    ...
    if not admin and not creator:
        await event.reply("I Need Admin rights 🤔")
        return
