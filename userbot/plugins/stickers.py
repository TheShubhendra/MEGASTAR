...
KANGING_STR = [
    "look there dear.. lemme steal your sticker",
    "Hey dude..Do you know i like your stickers very much...",
    "..Aloo policee.. me stealing sticker📞📞..",
    "What a beautiful sticker dear!!...",
    "why you are here🙄🤔..just go and play ff.._-_-_-_-_-_-_-_😁..",
    "Hehe me steàl ur stikér\nhehe.",
    "Ay look over there (☉｡☉)!→\nWhile I kang this...",
...
async def kang(args):
    ...
    if photo:
        ...
        if "  A <strong>Telegram</strong> user has created the <strong>Sticker&nbsp;Set</strong>." not in htmlstr:
            ...
            await args.edit("`Creating a new Pack...`")
            async with bot.conversation('Stickers') as conv:
                await conv.send_message(cmd)
                await conv.get_response()
                # Ensure user doesn't get spamming notifications
